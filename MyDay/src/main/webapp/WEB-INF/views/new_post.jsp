...
<script type='text/javascript'>
	...
	setInterval(function() {
		CharacterCount('text_body', 'CharCountLabel1')
	}, 55);
</script>
...
<%
	int authorID = new AccountDAOImpl().getIDByLogin(session
	...
	<table>
		<tr>
			...
			<td><input type="text" name="title" /> <input type="hidden"
				name="authorID" value="<%=authorID%>"></td>

		</tr>
		<tr>
			<td></td>
			<td><textarea rows="4" cols="50" id="text_body" name="body"
